...
public class CustomersAdminPageUIs{
    ...
    public final static String CUSTOMER_ROLES_SELECT = "xpath=//select[@id='SelectedCustomerRoleIds']";
    public final static String SAVE_CONTINUE_EDIT_BUTTON = "xpath=//button[@name='save-continue']";
    ...
    public final static String DELETE_ROLES = "xpath=//li[@class='k-button']//span[@class='k-select']";
