...
public class RegisterPageUIs {
	...
	public final static String MESSAGE_EMAIL_EXISTS = "xpath=//div[@class='message-error validation-summary-errors']//li";
	public final static String MESSAGE_ERROR_PASS_LESS_6 = "xpath=//span[@id='Password-error']";
