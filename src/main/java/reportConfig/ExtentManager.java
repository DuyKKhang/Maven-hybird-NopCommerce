...
public class ExtentManager {
    ...
    public synchronized static ExtentReports createExtentReports() {
        ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstants.getGlobalConstants().getProject_path() + "/extentV5/ExtentReport.html");
        ...
        extentReports.setSystemInfo("Team", "TNHH 1 Member");
